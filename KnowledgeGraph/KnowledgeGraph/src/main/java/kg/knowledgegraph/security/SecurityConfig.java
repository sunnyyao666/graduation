package kg.knowledgegraph.security;

import kg.knowledgegraph.security.jwt.JwtRequestFilter;
import kg.knowledgegraph.service.JwtUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/user/logIn", "/user/register", "/hello", "/test").permitAll()
